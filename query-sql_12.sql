...
GRANT SELECT, UPDATE, DELETE ON product_managements.* TO 'user1'@'localhost';

-- 5. Berikan hak akses kepada user2@localhost agar bisa melakukan INSERT di tabel products
GRANT INSERT ON product_managements.products TO 'user2'@'localhost';

-- 6. Berikan hak akses kepada user3@localhost agar bisa melakukan UPDATE di kolom stock tabel products
GRANT UPDATE(stock) ON product_managements.products TO 'user3'@'localhost';
...
REVOKE INSERT ON product_managements.products FROM 'user2'@'localhost';
...
GRANT SELECT, UPDATE ON product_managements.products TO sales;

-- 16. Menggunakan SHOW GRANT statement, buktikan bahwa poin 14 dan 15 berhasil.
SHOW GRANTS FOR 'last_name'@'localhost', 'fist_name'@'localhost';